...
<template>
  <!-- search mode toggle -->
  <div
    class="flex m-8 mt-0 gap-3 bg-neutral-900 p-2 rounded-lg md:w-3/5 md:mx-auto *:w-full *:rounded-lg font-semibold text-xl *:py-2 *:transition-all *:duration-200 *:hover:brightness-105"
  >
    <button
      :class="{
